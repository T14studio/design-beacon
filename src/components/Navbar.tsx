      ...
      <nav className="container mx-auto flex items-center justify-between h-24 px-6">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="flex items-center gap-2 text-sm font-medium tracking-widest uppercase text-foreground/70 hover:text-primary transition-colors duration-300"
          >
      ...
      {open && (
        <div className="md:hidden fixed inset-0 bg-background/95 backdrop-blur-lg z-40 flex flex-col items-center justify-center gap-8">
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={() => setOpen(false)}
            className="flex items-center gap-3 text-2xl font-light tracking-widest uppercase text-foreground hover:text-primary transition-colors"
          >
