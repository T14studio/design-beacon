...
const navLinks = [
  ...
  { label: "Lan├ºamentos", path: "/imoveis?type=lancamento" },
];
    ...
    <header className="fixed top-0 left-0 right-0 z-50 glass">
      <nav className="container mx-auto flex items-center justify-between h-16 sm:h-20 md:h-24 px-4 sm:px-6">
        ...
        <div className="hidden md:flex items-center justify-end gap-4 lg:gap-6 flex-1">
          <a
            href="https://wa.me/5567991193513?text=Ol├í! Gostaria de falar com um especialista sobre os im├│veis."
            target="_blank"
        ...
        <button
          ...
          className="md:hidden text-foreground z-50 flex-1 flex justify-end"
          aria-label="Menu"
        >
      ...
      {open && (
        <div className="md:hidden fixed inset-0 bg-background/95 backdrop-blur-xl z-40 flex flex-col justify-center px-6 pt-20 pb-10 overflow-y-auto">
          <div className="flex flex-col gap-6 max-w-sm mx-auto w-full">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setOpen(false)}
              className="mt-6 flex items-center justify-center gap-3 text-base sm:text-lg font-bold tracking-widest uppercase text-background bg-[#25D366] hover:bg-[#1DA851] py-5 rounded-full shadow-lg shadow-[#25D366]/20 transition-all btn-shine"
            >
