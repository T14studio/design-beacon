    ...
    return (
      ...
      >
        ...
        <div className="relative h-64 md:h-80 overflow-hidden">
          ...
          />
          <span className="absolute top-4 left-4 bg-primary text-primary-foreground text-xs font-mono tracking-widest uppercase px-3 py-1 rounded-sm">
            {property.mode}
          </span>
        </div>
        ...
        <div className="flex flex-col justify-center p-8 md:p-12">
          <span className="font-mono text-xs tracking-widest uppercase text-primary mb-2">
