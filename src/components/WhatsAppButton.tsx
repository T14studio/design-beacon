const WHATSAPP_NUMBER = "5567996241515";
...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#25D366] text-white shadow-xl shadow-[#25D366]/30 hover:scale-110 active:scale-95 transition-all duration-300 animate-fade-in"
      aria-label="WhatsApp"
    >
      <svg viewBox="0 0 32 32" width="28" height="28" fill="currentColor" className="md:w-8 md:h-8">
