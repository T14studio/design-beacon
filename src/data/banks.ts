...
export const BANKS: BankConfig[] = [
  {
    ...
    logo: "https://upload.wikimedia.org/wikipedia/commons/a/ae/Caixa_Econ%C3%B4mica_Federal_logo.svg",
    ui: {
  ...
  },
  {
    ...
    name: "Itaú Unibanco",
    shortName: "Itaú",
    logo: "https://upload.wikimedia.org/wikipedia/commons/4/4b/Ita%C3%BA_Unibanco_logo.svg",
    annualRate: 9.89,
    rateDisplay: "TR + 9,89%",
    maxYears: 30,
    minDownPaymentPercent: 20,
  ...
  },
  {
    ...
    shortName: "BB",
    logo: "https://upload.wikimedia.org/wikipedia/commons/c/cd/Banco_do_Brasil_logo.svg",
    annualRate: 9.29,
    rateDisplay: "TR + 9,29%",
    maxYears: 35,
    minDownPaymentPercent: 20,
  ...
  },
  {
    ...
    name: "Bradesco",
    shortName: "Bradesco",
    logo: "https://upload.wikimedia.org/wikipedia/commons/1/1a/Bradesco_logo.svg",
    annualRate: 9.99,
    rateDisplay: "TR + 9,99%",
    maxYears: 30,
    minDownPaymentPercent: 20,
  ...
  },
  {
    ...
    logo: "https://upload.wikimedia.org/wikipedia/commons/8/87/Banco_Inter_logo.svg",
    ui: {
  ...
  },
  {
    ...
    logo: "https://upload.wikimedia.org/wikipedia/commons/c/c8/Logo_btg_pactual.svg",
    ui: {
  ...
  },
  {
    ...
    name: "Sicredi",
    shortName: "Sicredi",
    logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Logotipo_Sicredi.svg/512px-Logotipo_Sicredi.svg.png",
    annualRate: 9.69,
    rateDisplay: "TR + 9,69%",
    maxYears: 30,
    minDownPaymentPercent: 20,
