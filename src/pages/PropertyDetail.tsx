              ...
              <ScrollReveal delay={200}>
                <div className="bg-card/40 backdrop-blur-md border border-border rounded-2xl p-6 sm:p-8 sticky top-32 shadow-2xl">
                  ...
                  <div className="mt-6 pt-6 border-t border-border/50 space-y-4">
                    <Button
                      onClick={() => {
                        const event = new CustomEvent("open-axis-chat", {
                          detail: {
                      ...
                      variant="outline"
                      className="w-full border-primary/20 hover:bg-primary/5 text-primary font-bold tracking-widest uppercase h-14 rounded-full transition-all flex items-center justify-center gap-2"
                    >
