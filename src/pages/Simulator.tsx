          ...
          <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8">
              ...
              <div className="bg-card/40 backdrop-blur-xl border border-border/50 rounded-[2rem] p-8 shadow-2xl relative overflow-hidden h-fit lg:sticky lg:top-32">
                ...
                <div className="relative z-10 mb-6">
                  <Select value={selectedBank} onValueChange={setSelectedBank}>
                    <SelectTrigger className="w-full bg-background/50 h-14 rounded-2xl border-border/40 focus:ring-primary/20 text-sm px-5 font-bold hover:bg-background/80 transition-all">
            ...
            <ScrollReveal delay={150}>
              ...
              <div className="mt-10 flex flex-wrap justify-center gap-6">
                <Button size="lg" className="bg-gold-gradient text-primary-foreground font-bold px-12 h-16 rounded-full hover:opacity-90 transition-all shadow-xl btn-shine uppercase tracking-widest text-[11px]">
                  Simular agora
                </Button>
                <Button asChild variant="outline" size="lg" className="border-primary/30 text-primary hover:bg-primary/10 px-12 h-16 rounded-full font-bold tracking-widest uppercase text-[11px]">
                  <a href="https://wa.me/5567991193513?text=Olá! Gostaria de falar com um especialista sobre simulação de financiamento." target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
                    <svg viewBox="0 0 32 32" className="w-5 h-5 text-[#25D366] fill-current">
