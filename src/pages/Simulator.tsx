        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-8">
                ...
                <div className="relative z-10">
                  ...
                  >
                    <div className="flex items-center gap-4 mb-4">
                       {selectedBank.logo ? (
                         <div className="w-12 h-12 flex items-center justify-center p-1 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20">
                           <img src={selectedBank.logo} alt={selectedBank.name} className="w-full h-full object-contain drop-shadow-md" />
                         </div>
                       ) : (
            ...
            <ScrollReveal delay={150}>
              <FinancingSimulator bank={selectedBank} />
              
              <div className="mt-10 flex flex-col sm:flex-row flex-wrap items-center justify-center gap-4 sm:gap-6">
                <Button className="bg-gold-gradient text-primary-foreground font-bold px-6 sm:px-12 h-12 sm:h-14 md:h-16 rounded-full hover:opacity-90 transition-all shadow-xl btn-shine uppercase tracking-widest text-[10px] sm:text-[11px] w-[280px] max-w-full sm:w-auto">
                  Simular agora
                </Button>
